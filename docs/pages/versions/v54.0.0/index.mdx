...
🔹 TRADING SOFTWARE / APK UI PROMPT (EXACT STYLE)

Prompt:

> Design a modern dark-theme mobile trading application UI.

When the APK opens, the home screen should immediately display a live candlestick chart similar to professional binary/options trading platforms.

UI DETAILS:

Background: deep dark navy / charcoal black

Chart type: Candlestick chart

Bullish candles: teal / light green

Bearish candles: yellow-orange

Smooth candle animation (real-time price movement)

Dotted vertical expiry line on the right side

Dotted horizontal price line across the chart

Price label box near candles (example: 0.18565)

Countdown timer bubble on right side (example: 00:02)


TOP BAR:

App logo on top left (rounded square icon, purple/gradient style)

App name text next to logo

Search icon

Tabs: Activated | Stopped | Featured
...
Trading pair text (example: USD/BRL OTC)

Percentage payout (example: 93%)

Small subtitle text below


STYLE:

Minimal, professional, fintech look
...
The app should look like a real professional trading platform, fast, smooth, and premium.
...
🔹 अगर APK बनवानी है (REALITY CHECK)

मैं APK फ़ाइल खुद से generate नहीं कर सकता, लेकिन:
...
👉 ये सब मैं 100% help कर सकता हूँ।

अगर तुम चाहो तो अगला स्टेप बताओ: 1️⃣ Flutter code
2️⃣ React Native code
3️⃣ Only UI design (Figma style)
4️⃣ Chart library recommendation-
title: Reference
hideTOC: true
---
